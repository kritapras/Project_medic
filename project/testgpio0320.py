...
def mainfunc():
    ...
    #    print "Solenoid 2: ON"
    #    print "Solenoid 3: ON"
    print "medic1 = %d , medic2 = %d , medic3 = %d" % (medic_count1,medic_count2,medic_count3)
    if (sol1 == 1) & (flag1 == 0) & (medic_count1 != 0):
        update()
        ...
        for i in range (0,medic_count1):
            ...
            time.sleep(2)
            flag1=1
    if (sol2 == 1)  & (flag2 == 0)& (medic_count2 != 0):
        update()
    ...
    if (sol3 == 1)  & (flag3 == 0)& (medic_count3 != 0):
        update()
