...
var get_time = $.ajax({
 ...
 // Modal and toggle beep sound/////////////////////////////////////////////////////
    ...
    function loadDoc() {
    		...
    		else if(takenow == 2 && ((med1_meal_mor ==1) || (med2_meal_mor== 1) || (med3_meal_evn == 1 ))){
    			$("#mealbf").text("รับประทานอาหารมื้อ ; กลางวัน ; ก่อนอาหาร");
    		}
    		else if(takenow == 3 && ((med1_meal_mor ==1) || (med2_meal_mor== 1) || (med3_meal_evn == 1 ))){
    			$("#mealbf").text("รับประทานอาหารมื้อ ; เย็น ; ก่อนอาหาร");
    		}
    		else if(takenow == 4 && ((med1_meal_mor ==1) || (med2_meal_mor== 1) || (med3_meal_evn == 1 )) ){
    			$("#mealbf").text("รับประทานอาหารมื้อ ; ก่อนนอน ; ก่อนอาหาร");
    			}
    		}
    		else {
    		if(takenow == 1 && ((med1_meal_mor ==1) || (med2_meal_mor== 1) || (med3_meal_evn == 1 ))){
    			$("#mealbf").text("รับประทานอาหารมื้อ ; เช้า ; หลังอาหาร");
    		}
    		else if(takenow == 2 && ((med1_meal_mor ==1) || (med2_meal_mor== 1) || (med3_meal_evn == 1 ))){
    			$("#mealbf").text("รับประทานอาหารมื้อ ; กลางวัน ; หลังอาหาร");
    		}
    		else if(takenow == 3 && ((med1_meal_mor ==1) || (med2_meal_mor== 1) || (med3_meal_evn == 1 ))){
    			$("#mealbf").text("รับประทานอาหารมื้อ ; เย็น ; หลังอาหาร");
    		}
    		else if(takenow == 4 && ((med1_meal_mor ==1) || (med2_meal_mor== 1) || (med3_meal_evn == 1 )) ){
        		...
        		if (((med1_count <=med2_count)) &&(med1_count <=med3_count)) 
    					...
    					//console.log(med1_count+med2_count+med3_count)
    			if ((med1_count < 6) ||(med2_count < 6) ||(med3_count < 6 )) {
    				var d = new Date();
    				var m = d.getMinutes();
    				var h = d.getHours();
    				console.log(med1_count_last+""+med2_count_last+""+med2_count_last)
    				if (med1_count_last != med1_count) {
    					med1_count_last=med1_count;
    					console.log(med1_count_last+""+med2_count_last+""+med2_count_last)
    					$("#myModal4").modal('show');
    				}
    				else if (med2_count_last != med2_count ) {
    					med2_count_last=med2_count;
    					console.log(med1_count_last+""+med2_count_last+""+med2_count_last)
    					$("#myModal4").modal('show');
    				}
					else if (med3_count_last != med3_count) {
    					med3_count_last=med3_count;
    					console.log(med1_count_last+""+med2_count_last+""+med2_count_last)
    					$("#myModal4").modal('show');
    				}
    				//console.log(m);
