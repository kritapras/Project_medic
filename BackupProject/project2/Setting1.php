...
<nav class="navbar navbar-inverse">
  ...
  <h2><span class="label label-success">แก้ไขข้อมูลยาเพื่อใช้ในการแจ้งเตือน</span></h2>
          ...
          <div>
              ...
              <div class="bg-1 col-sm-3 container"><a href="7display.php"><img src="return.png" class="img-responsive" alt="online" width="300" height="200"></a>
              </div>
              <div class="bg-1 col-sm-3 container"><a href="index.php"><img src="home.png" class="img-responsive" alt="offline" width="250" height="200"></a>
          </div>
<br><br>
