  ...
  <div>
      <div class="container col-sm-6" style="color: white">
        <h2>แก้ไขข้อมูลยาเพื่อใช้ในการแจ้งเตือน</h2>
          ...
          <select style="color:black" id="user">
          	<option value="medic1">ยาตัวที่ 1</option>
 			 	<option value="medic2">ยาตัวที่ 2</option>
  				<option value="medic3">ยาตัวที่ 3</option>
          </select>
          ...
          <h3 style="color: black"><input type="submit" value="ส่งข้อมูล"></h3>
      </div>
      <div class="container col-sm-5" style="color:white">
      <h3><label for="pwd">วิธีการรับประทาน</label></h3>
        <div>
            <div class="checkbox" style="background-color:#3366ff " name="">
               <label class="checkbox-inline font"><h3><input type="checkbox" value="1">เช้า</h3></label>
                <label class="checkbox-inline font"><h3><input type="checkbox" value="1">กลางวัน</h3></label>
                <label class="checkbox-inline font"><h3><input type="checkbox" value="1">เย็น</h3></label>
                <label class="checkbox-inline font"><h3><input type="checkbox" value="1">ก่อนนอน</h3></label>
            </div>
						  <audio id="audio" src="beep.mp3" autostart="false" ></audio>
            <div class="radio">
              <table>
                <th><label class="radio-inline font"><h3 style="color: white"><input type="radio" name="optradio">ก่อนอาหาร  </h3></label></th>
                <th><label class="radio-inline font"><h3 style="color: white"><input type="radio" name="optradio">หลังอาหาร  </h3></label></th>
              </table>
            </div>
      </div>
  </form>
