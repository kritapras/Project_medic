...
<nav class="navbar navbar-inverse">
        ...
        <li>
           ...
           $("#user1").click(function () 
			...
			$("#user2").click(function () 
            				...
            				else if ($("#user2").attr('src') == "offline.png" ) {
            					$("#user1").click(function () 
            					{
									$("#user2").attr('src', "online.png");
									$("#user1").attr('src', "offline.png");
  ...
  <h2><span class="label label-success">แก้ไขข้อมูลเวลารับประทานยา</span></h2>
              ...
              <div>
          		...
          		<div class="bg-1 col-sm-3 container"><a href="7display.php"><img src="return.png" class="img-responsive"  width="300" height="100" ></a>
          		</div>
          		<div class="bg-1 col-sm-3 container"><a href="index.php"><img src="home.png" class="img-responsive"  width="250" height="50"></a>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content h2" style="background-color: #002699;color: white"> 
            ...
            <table class="table-responsive" style="width: 100%;border-color: ">
                    <th><img id="med1_take_count" class="img-responsive" width="400" height="200"></th>
                    <th><img id="med2_take_count"  class="img-responsive" width="400" height="200"></th>
                    <th><img id="med3_take_count" class="img-responsive" width="400" height="200"></th>
              </table>              
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-default" data-dismiss="modal">ปิดหน้าต่าง</button>
