...
<html lang="en">
<head>
  <title>Medicine Cabinet for eyesight problem and Elderly Person via internet of thing</title>
  <meta charset="utf-8">
...
p.customfont { 
  ...
  *{
    font-family: "My Custom Font"
		...
		<body style="width: 100%" style="height: 100%">
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar"><b>
      ...
      <div>
        <table width="100%">
          <td class="bg-1 text-center col-sm-6"><h1><i style="color: white;font-size: 150%" class="thai">กรุณานำขวดยาไปแนบบริเวณนี้เพื่ออ่านฉลากยา</i></h1></p></div></td>
          <td class="bg-1 text-center col-sm-6"><img src="Arrow.png"  alt="Arrow" class="img-responsive" width="90%" height="30%" ></td>
				  </div>
        </table>
      </div>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content h2" style="background-color: #002699;color: white"> 
            ...
            <div class="modal-body">
              ...
              <p>รับประทานมื้อ : <p id="meal">เช้า</p> : <p id="ba">ก่อนอาหาร </p></p>
